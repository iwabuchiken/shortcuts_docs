...
REM =================================
rem set folder_2=C:\WORKS_2\WS\WS_Cake_IFM11\photo-books\95_inaka\1_
set folder_2=C:\WORKS_2\WS\WS_Cake_IFM11\photo-books\95_inaka\3_furoku

REM =================================
rem : target page
REM =================================
rem %%%
set fname=2021-03-06_12-29-45_000.jpg

REM =================================
set fname_batch="start_log_JVE_64.[95_inaka].bat"

set fname_log="log-session_JVE_64.[95_inaka].log"
...
REM opening message
echo start_log_JVE_64.[95_inaka].bat ==^> starting...

REM =================================
REM 	update batch file
REM 	2021年1月28日0:29:12
REM =================================
echo.>> "C:\WORKS_2\shortcuts_docs\start_log_JVE_64.[95_inaka].bat"
...
set url_1="http://benfranklin.chips.jp/cake_apps/Cake_IFM11/images/index_2?filter_memo=95+田舎&sort=file_name&direction=desc&RBs_AND_OR_Memo=AND"
