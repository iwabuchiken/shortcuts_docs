...
set folder_2=C:\WORKS_2\WS\WS_Cake_IFM11\photo-books\128_siso-taikei_honda\1_hisaku

REM =================================
rem : target page
REM =================================
rem %%%
set fname=2019-08-22_04-38-59_000.jpg

REM =================================
set fname_batch="start_log_JVE_64.[128_honda].bat"

set fname_log="log-session_JVE_64.[128_honda].log"
...
set url_1="http://benfranklin.chips.jp/cake_apps/Cake_IFM11/images/index_2?filter_memo=jve+64+128+honda&sort=file_name&direction=desc&RBs_AND_OR_Memo=AND"
