...
REM opening message
echo res_[37#21.7_mathematics].[theme=fractal]...

REM =================================
REM 	update batch file
REM 	2020年10月24日13:20:36
REM =================================
echo.>> "C:\WORKS_2\shortcuts_docs\start_res_[37#21.7_mathematics].[theme=fractal].bat"
...
start log_res_[37#21.7_mathematics].[theme=fractal].[20201020_152846].txt
