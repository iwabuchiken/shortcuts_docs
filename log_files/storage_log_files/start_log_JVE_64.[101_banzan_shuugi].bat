...
REM =================================
rem %%%
set fname=2021-04-06_18-05-38_000.jpg

REM =================================
set fname_batch="start_log_JVE_64.[101_banzan_shuugi].bat"

set fname_log="log-session_JVE_64.[101_banzan_shuugi].log"
...
set url_1="http://benfranklin.chips.jp/cake_apps/Cake_IFM11/images/index_2?filter_memo=101+集義&sort=file_name&direction=desc&RBs_AND_OR_Memo=AND"
