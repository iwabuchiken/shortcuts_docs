...
REM =================================
set folder_2=C:\WORKS_2\WS\WS_Cake_IFM11\photo-books\78_goedel\2_
...
REM =================================
rem %%%
set fname=2020-11-10_16-43-11_000.jpg

REM =================================
set fname_batch="start_log_JVE_64.[78_goedel].bat"
set dpath_batch=C:\WORKS_2\shortcuts_docs

set fpath_batch="%dpath_batch%\%fname_batch:"=%"

set fname_log="log-session_JVE_64.[78_goedel].log"
set fpath_log="%dpath_batch%\%fname_log:"=%"

rem : "注"
rem : %%%
set fname_remarks=2020-11-10_16-46-38_000.jpg
set dpath_remarks=C:\WORKS_2\WS\WS_Cake_IFM11\photo-books\78_goedel\X_trans-remarks

set fpath_remarks="%dpath_remarks%\%fname_remarks%"
...
rem rem : test
rem echo %fpath%
rem echo %fpath_remarks%

rem echo %fpath_batch%

rem rem %command_path_sakura% %fpath_remarks%
rem %fpath_remarks%
...
start rundll32.exe "C:\Program Files\Windows Photo Viewer\photoviewer.dll",ImageView_Fullscreen %fpath_remarks:"=%
...
set url_1="http://benfranklin.chips.jp/cake_apps/Cake_IFM11/images/index_2?filter_memo=78+goedel&sort=file_name&direction=desc&RBs_AND_OR_Memo=AND"
