...
set folder_2=C:\WORKS_2\WS\WS_Cake_IFM11\photo-books\111_ujishuui\ujishuui_1_

REM =================================
rem : target page
REM =================================
rem %%%
set fname=2021-06-11_23-47-57_000.jpg
...
set url_1="http://benfranklin.chips.jp/cake_apps/Cake_IFM11/images/index_2?filter_memo=jve+64+111&sort=file_name&direction=desc&RBs_AND_OR_Memo=AND"
