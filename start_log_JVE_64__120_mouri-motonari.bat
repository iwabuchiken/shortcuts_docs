...
rem 64__120_mouri-motonari
REM =================================
REM 	variables
REM 	2021年1月28日0:29:04
REM =================================

set folder_2=C:\WORKS_2\WS\WS_Cake_IFM11\photo-books\120_mouri-motonari
...
set fname_log="log-session_JVE_64__120_mouri-motonari.log"
...
rem set url_1="http://benfranklin.chips.jp/cake_apps/Cake_IFM11/images/index_2?filter_memo=jve+64+111&sort=file_name&direction=desc&RBs_AND_OR_Memo=AND"
...
rem 
rem start C:\WORKS_2\shortcuts_docs\end_log_JVE_64_94_kinshiroku.bat
