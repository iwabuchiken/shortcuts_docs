...
set folder_2=C:\WORKS_2\WS\WS_Cake_IFM11\photo-books\100_rantou\1_

REM =================================
rem : target page
REM =================================
rem %%%
set fname=2021-03-07_15-55-47_000.jpg

REM =================================
set fname_batch="start_log_JVE_64.[100_rantou].bat"

set fname_log="log-session_JVE_64.[100_rantou].log"
...
REM =================================
echo.>> "C:\WORKS_2\shortcuts_docs\%fnae_batch:"=%"
...
set url_1="http://benfranklin.chips.jp/cake_apps/Cake_IFM11/images/index_2?filter_memo=100+蘭東&sort=file_name&direction=desc&RBs_AND_OR_Memo=AND"
